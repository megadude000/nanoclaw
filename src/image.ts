...
/**
 * Resize an image buffer and save it to the group's attachments directory.
 * Returns a content string with the [Image: path] reference that downstream
 * code (parseImageReferences) can extract.
 */
...
/**
 * Scan an array of messages for [Image: attachments/...] references
 * and return structured attachment metadata for the container runner.
 */
